...
// Chart5: Top 5 YouTube channels — Quarterly income (stacked, horizontal, Show: checkboxes)
...
(function () {
  ...
  const g = svg
    ...
    .attr(
      "transform",
      `translate(${margin.left}, ${margin.top + controlsH + 20})`
    )
  ...
  const fmt = (v) =>
    v >= 1e6 ? (v / 1e6).toFixed(1) + "M" : d3.format(".2s")(v);
          ...
          .on("mouseover", (event, d) => {
            tooltip.style("display", "block").html(
              `<div style="font-family:'Montserrat',sans-serif;font-weight:700;margin-bottom:6px">${
               ...
               Q1: ${fmt(d.Q1)}&nbsp;&nbsp;Q2: ${fmt(
                d.Q2
              )}&nbsp;&nbsp;Q3: ${fmt(d.Q3)}&nbsp;&nbsp;Q4: ${fmt(d.Q4)}<br/>
               <div style="margin-top:6px;font-weight:700">Total: ${fmt(
                 d.total
               )}</div>`
            );
          })
